...
input_dir = '/Users/vee/Desktop/Havas Media/data'
output_dir = '/Users/vee/Desktop/Havas Media/output'

meta_df = pd.read_csv(f'{input_dir}/cleaned_meta.csv')
...
meta_weekly_impressions.to_csv(f'{output_dir}/meta_weekly_impressions.csv', index=False)
...
# Save the plot 
fig.write_html(f'{output_dir}/total_impressions_by_week.html')
...
fig2.write_html(f'{output_dir}/weekly_impressions_by_duration.html')
