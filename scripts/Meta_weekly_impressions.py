...
def run(data_dir, output_dir):
    ...
    meta_df = pd.read_csv(os.path.join(data_dir, 'cleaned_meta.csv'))
    ...
    meta_weekly_impressions.to_csv(os.path.join(output_dir, 'meta_weekly_impressions.csv'), index=False)
    ...
    # Save the plot 
    fig.write_html(os.path.join(output_dir, 'total_impressions_by_week.html'))
    ...
    fig2.write_html(os.path.join(output_dir, 'weekly_impressions_by_duration.html'))
    
    print("Meta weekly impression analysis complete!")
    return meta_weekly_impressions
