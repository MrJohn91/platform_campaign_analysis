...
try:
    ...
    print("Error: platform_data.csv not found in data folder.")
    exit(1)
except Exception as e:
    print(f"Error loading platform_data.csv: {e}")
    exit(1)
...
try:
    ...
    print(f"Error saving Total_Impressions_by_Platform.html: {e}")
    exit(1)
...
try:
    ...
    print(f"Error saving CTR_by_Platform.html: {e}")
    exit(1)
...
try:
    ...
    print(f"Error saving Video_Completion_Metrics_by_Platform.html: {e}")
    exit(1)
...
try:
    ...
    print(f"Error saving Video_Completions_by_Device_Type_and_Platform.html: {e}")
    exit(1)
...
try:
    ...
    print(f"Error saving Impressions_Over_Time_by_Platform.html: {e}")
    exit(1)
